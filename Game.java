...
public class Game implements Constants {
    ...
    public static void main(String[] args) throws IOException {
        ...
        xPlayer = create_player (name, LETTER_X, theGame.theBoard, stdin, random_gen);
        ...
        oPlayer = create_player (name, LETTER_O, theGame.theBoard, stdin, random_gen);
    ...
    static public Player  create_player(String name, char mark, Board board,
                                        BufferedReader stdin, RandomGenerator rg)throws IOException {
        // Get the player type.
        ...
        switch(player_type) {
            case 1:
                ...
                break;
            case 2:
                result = new RandomPlayer(name, mark, rg);
                break;
            case 3:
                result = new BlockingPlayer(name, mark, rg);
                break;
            case 4:
